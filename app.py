...
app.config["SQLACHEMY_DATABASE_URI"] = DATABASE_URI
...
def seed_tables():
    ...
    product1 = Product(
        name="Product 1", description="This is Product 1", price=12.99, stock=5
    )

    product2 = Product(
        name="Product 2", description="This is Product 2", price=13, stock=0
    )
...
def get_a_product(product_id):
    ...
    if product:
        ...
        return (
            jsonify({"message": f"Product with id {product_id} does not exist."}),
            404,
        )
